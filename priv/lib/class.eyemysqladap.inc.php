...
class EyeMySQLAdap
{
	...
	{
		$result = query_db($query, $this->link);
	...
	{
		$this->resCalc($result);
		return (int) query_db_num($result);
	}
	...
	{
		return (int) myquery_db_assocc($this->link);
	}
