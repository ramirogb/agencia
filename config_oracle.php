...
global $database_conexionxcz1;
global $username_conexionxcz1;
global $password_conexion1xcz;
$hostname_conexion1=$DBHost;
$database_conexion1=$DBName;
$username_conexion1=$DBUser;
$password_conexion1=$DBPassword;
global $conexionxcz1;
$conexionxcz1 = @mysql_connect($hostname_conexion1, $username_conexion1, $password_conexion1) or trigger_error(mysql_error(),E_USER_ERROR); 
