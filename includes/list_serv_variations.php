...
$query_agencias = "SELECT * FROM servicios_variations";
...
<p align="center">&nbsp; <strong><?php echo $variations; ?></strong></p>

<table width="80%"  style="padding-left:20px " border="0" cellpadding="0" cellspacing="0" class="tables">
    <tr class="comment3">
      <td width="9">&nbsp;</td>
      <td width="34">&nbsp;</td>
      <td width="33">&nbsp;</td>
    ...
    <tr   class="comment3">
      <td>&nbsp;</td>
      <td><a href="<?php echo $_SERVER['PHP_SELF'] ?>?action=create_serv_type"><img src="images/new_record.jpg" width="16" height="16" border="0"></a></td>
      <td>&nbsp;</td>
      <td width="98">C&oacute;digo</td>
    ...
    <tr  class="<?php set_class(); ?>" >
      <td>&nbsp;</td>
      <td><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=edit_serv_type&code=<?php echo $row_agencias['kind']; ?>"><img src="images/edit.png" alt="Editar" width="17" height="17" border="0"></a></td>
      <td><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=del_serv_type&code=<?php echo $row_agencias['kind']; ?>"><img src="images/delete.png" alt="Borrar" width="16" height="16" class="delete"  border="0"></a></td>
      <td class="comment3"><?php echo $row_agencias['kind']; ?></td>
      <td class="comment3"><?php echo $row_agencias['descript']; ?></td>
      <td class="comment3"><?php 
$tt=$row_agencias['kind'];
	  	$queryggf = " SELECT * from  type_lang, languajes	where  tipe='$tt' and languajes.lang=type_lang.lang";	
