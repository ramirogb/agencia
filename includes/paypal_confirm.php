	...
	*/
	...
	if( $ack == "SUCCESS" )
	{
		...
		*/
		...
		$insertSQL = "	INSERT INTO paypal_confirm
						SET
						item_name     = '".$_SESSION['reserva']."',
						payer_id    = '". $_SESSION['payer_id_']."',
						firstName    = '". $_SESSION['firstName_']."',
						cntryCode    = '". $_SESSION['cntryCode_']."',
						phonNumber    = '".$_SESSION['phonNumber_']."',
						payment_status = '".$paymentStatus."',
						payment_amount    = '".$amt."',
						txn_id    = '".$currencyCode."',
						payer_email    = '".$_SESSION['payer_email_']."',
...
$deuda=$row3x8['they_owe_you']-$amt;

	$querygg="update reserv_master set they_owe_you= '$deuda' where DocNro='$id' ";
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><strong><?php echo 	$order_confirmation; ?>&nbsp;
        </strong>      <p><?php echo 	"$transaction: $transactionId $transactionType"; ?> <br>
            <?php echo $paymentTypeecheck ?><br>
        <?php echo $orderTime ?><br>
        <?php echo "$amount:$currencyCode $amt"; ?>    </td>
  </tr>
</table>
