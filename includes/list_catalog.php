...
$query_agencias = "SELECT * FROM tarifarios";
...
<table width="60%"  style="padding-left:20px " border="0" cellpadding="0" cellspacing="0" class="tables">
    ...
    <tr   class="comment3">
      <td>&nbsp;</td>
      <td><a href="<?php echo $_SERVER['PHP_SELF'] ?>?action=create_cat"><img src="images/new_record.jpg" width="16" height="16" border="0"></a></td>
      <td>&nbsp;</td>
      <td width="131">ID</td>
    ...
    <tr  class="<?php set_class(); ?>" >
      <td>&nbsp;</td>
      <td><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=edit_catalog&code=<?php echo $row_agencias['id']; ?>"><img src="images/edit.png" alt="Editar" width="17" height="17" border="0"></a></td>
      <td><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=del_catalog&code=<?php echo $row_agencias['id']; ?>"><img src="images/delete.png" alt="Borrar" width="16" height="16" class="delete"  border="0"></a></td>
      <td class="comment3"><?php echo $row_agencias['id']; ?></td>
      <td class="comment3"><?php echo $row_agencias['tarif_cdg']; ?></td>
      <td colspan="2" class="comment3"><?php echo $row_agencias['descript']; ?></td>
    </tr>
