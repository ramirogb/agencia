/*
 overlibmws_modal.js plug-in module - Copyright Foteos Macrides 2006-2007. All rights reserved.
   ...
   Initial: November 15, 2006 - Last Revised: March 10, 2007
...
var OLmMask=null,OLmMaskOn=0,OLmSelectOK=(OLie7||OLop7||OLgek>=20030624)?1:0,
...
OLmRoot=(o3_frame.document.compatMode&&o3_frame.document.compatMode=='BackCompat')?
'body':'html';var doCss=(!OLgetRef('modalMask'))?1:0,zI=(over)?over.style.zIndex-2:998;
OLmMask=OLmkLyr('modalMask',o3_frame,zI);if(doCss){var o=OLmMask.style;o.display='none';
o.top='0px';o.left='0px';o.width='100%';o.height='100%';o.visibility='visible';
o.backgroundColor='#bbbbbb';if(OLie4&&!OLieM&&typeof o.filter=='string'){
o.filter='Alpha(opacity=40)';if(OLie55)OLmMask.filters.alpha.enabled=1;}else{
...
OLmAddEv(window,"resize",OLmHandleMask);OLmShowMask();
}
...
OLmHandleMask();OLmSetMaskSize();if(!OLmSelectOK)OLmHideSB();
}
function OLmHandleMask(){
if(OLmMaskOn){if(!OLmGotSc){
OLmScLeft=parseInt((OLie4&&!OLop7?OLfd(o3_frame).scrollLeft:o3_frame.pageXOffset),10);
OLmScTop=parseInt((OLie4&&!OLop7?OLfd(o3_frame).scrollTop:o3_frame.pageYOffset),10);
OLmGotSc=1;}var root=o3_frame.document.getElementsByTagName(OLmRoot)[0];
if(root.style.overflow!='hidden')root.style.overflow='hidden';
var scLeft=parseInt((OLie4&&!OLop7?OLfd(o3_frame).scrollLeft:o3_frame.pageXOffset),10),
scTop=parseInt((OLie4&&!OLop7?OLfd(o3_frame).scrollTop:o3_frame.pageYOffset),10),
o=OLmMask.style;o.top=scTop+"px";o.left=scLeft+"px";o.top=scTop+"px";o.left=scLeft+"px";
OLmSetMaskSize();}
}
...
OLmMask.style.height=mHt+'px';OLmMask.style.width=root.scrollWidth+'px';
}
function OLmHideMask(){
OLmMaskOn=0;var root=o3_frame.document.getElementsByTagName(OLmRoot)[0];
root.style.overflow=(OLop7?'auto':'');if(!OLie4||OLop7){document.onkeypress=OLmKDH;OLmKDH=null;}
else OLmRestoreTI();if(!OLmSelectOK)OLmShowSB();OLmRemoveEv(window,"resize",OLmHandleMask);
if(o3_frame.scrollTo&&OLmGotSc){o3_frame.scrollTo(OLmScLeft,OLmScTop);OLmGotSc=0;}
if(OLgetRef('modalMask')&&OLmMask)OLmMask.style.display='none';OLmEdit=0;
}
