...
$cdg=$_GET['code'];$query_tarif = "SELECT * from servicios_variations WHERE kind='$cdg'";
...
<form method="post" name="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=update_serv_variations">
  <table height="132" align="center">
    ...
    <tr valign="baseline">
      ...
      <td  class="text"><input name="code" type="text" id="code" disabled  onChange="makeUppercase('code')" value="<?php echo $row_tarif['kind']; ?>" size="5">
      <input name="id" type="hidden" id="id" value="<?php echo $row_tarif['kind']; ?>"></td>
    </tr>
    <tr valign="baseline">
