...
//-->
    ...
    <?php ?>
          <select    name="tarifx[<?php echo $j; ?>]" id="tarifx[<?php echo $j; ?>]" onChange="MM_jumpMenu('parent',this,0)">
	...
	$row3x=query_db_assoc( $result577);	   	
			...
			if (!(strcmp( trim($_SESSION['catalog1']), $row3x['tarif_cdg'] ) ) ) {echo "SELECTED"; 
			$_SESSION['catae']=$row3x['tarif_cdg']; }
...
<p>&nbsp;</p>
  ...
  <tr style="padding-bottom:2px">
    <td colspan="4" bgcolor="#AACCEE"   style="padding-left:5px"><strong> <?php echo $services?></strong></td>
    <td colspan="7" bgcolor="#AACCEE"   style="padding-left:5px"><div align="right"></div></td>
    <td width="55" bgcolor="#AACCEE" >&nbsp;</td>
  </tr>
  <tr bgcolor="#EEEEEE">
    <td width="22" bgcolor="#EEEEEE" ><div align="center"><strong>N&ordm;</strong></div></td>
    <td width="122" ><div align="center"><strong><?php echo $date_reserv ?> <span class="boxborder text"><a href="#"><img src="images/plus.gif" width="14"  onClick="add_service()"  height="14" border="0"></a></span></strong></div></td>
    <td width="119" ><strong> <?php echo $hour_reserv ?></strong></td>
    <td width="119" >&nbsp;</td>
    <td width="91" ><div align="center"><strong><?php echo $text_titleclo
 ?></strong></div></td>
    <td width="58"><strong><?php echo $type_reserv
 ?></strong></td>
    <td width="103" ><strong><?php echo $lang_reserv
 ?></strong></td>
    <td width="54" ><strong>Paxes</strong></td>
    <td width="37" ><div align="center"><strong><?php echo $unit_price
 ?></strong></div></td>
    <td width="110" ><div align="center"><strong>Inc.</strong></div></td>
    <td width="22" ><div align="center"><strong><?php echo $comment
 ?></strong></div></td>
...
and tarifasdetalle.SerCdg='$tgt' and tarifasdetalle.Paxini='1'";	 
 ...
 ?>
  ...
  <input name="subtotal[<?php echo $j;  ?>]" type="hidden" id="subtotal[<?php echo $j;  ?>]" value="<?php  echo $sub_total[$j]  ?>">
    ...
    <tr bgcolor="<?php echo UseColor() ?>">
      <td colspan="12" class="boxborder text"><div   id='ajaxDiv2'></div></td>
      </tr> 
...
<p align="left">
  ...
  $totalRows_Recordset1 = 1; //50
$_SESSION['end']= $currentPage*$maxRows_Recordset1  + $totalRows_contenido;
if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
} else {
  $all_Recordset1 = 1;// 50; //query_db($query);
  $maxRows_Recordset1=1;//5;
  $totalRows_Recordset1 =1; // 50; //   query_db_num($all_Recordset1);
